...
import { BUTTONS_EXECUCAO, BUTTONS_PLANEJAMENTO, BUTTONS_PLANEJAMENTO_AUTORIZACAO, BUTTONS_PLANEJAMENTO_EDIT, DEFAULT_BUTTONS } from "@/utils/constants";
import { handleSubmit } from "@/fetch/fetchCadastro";
...
interface FormExecucaoProps {
  values: Demanda,
  id: string,
  categoria: string
}

const FormExecucao = ( { values, id, categoria } : FormExecucaoProps) => {
