...
interface FormPlanejamentoProps {
  values: Demanda,
  id: string,
  categoria: string
}

const FormPlanejamento = ( { values, id, categoria } : FormPlanejamentoProps) => {
  ...
  return (
    ...
    <form action={handleSubmit}>
      ...
      <input type='hidden' value={JSON.stringify(rows)} name="empresas"></input>
